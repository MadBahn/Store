...
<%--    从数据库取出--%>
    <ul class="nav">
      ...
      <li><input type="text" style="width: 120px" placeholder="请输入商品关键字">&nbsp;&nbsp;<button>搜索</button></input>
      </li>
    </ul>
    <ul class="join">
      <li><a href="#" hidden>APP下载</a></li>
      <li><a href="#" hidden>成都</a><i class="city"></i></li>
      <li><a href="#" hidden>消息</a></li>
...
<!-- 底部footer  start -->
<footer>
  <img class="footer-logo" src="img/footer-logo.png" height="36px" width="96px" alt>
